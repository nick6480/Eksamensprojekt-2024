...
{ 
    public class ConfigManager
    {
        ...
        public static ConfigManager LoadConfig(string path)
        {
            if (!File.Exists(path))
            {
                Console.Error.WriteLine("Configuration file not found."); // Indicate if configuration file is not found.
            ...
            {
                Console.Error.WriteLine("Error parsing configuration: " + ex.Message); // Indicate if there's an error parsing configuration.
                throw;
            }
        }
    }
